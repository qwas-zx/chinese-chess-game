...
- **人机对战模式**：基于 Minimax + Alpha-Beta 的增强型 AI，加入战术优先、移动排序、王安全、活动性和威胁评估，三档难度可调
...
- **估法函数**：结合棋子价值、棋子位置、王安全、活动性、威胁和防守判断
- **走法排序**：优先考虑吃子、将军、悬子捕获等战术性着法
- **搜索优化**：使用杀手走法、历史表和置换表，提升搜索效率
